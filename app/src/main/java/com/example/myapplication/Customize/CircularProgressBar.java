...
public class CircularProgressBar extends View {
    ...
    private final float mStartAngle = 0;      // Always start from top (default is: "3 o'clock on a watch.")
    private final float mMaxSweepAngle = 360;         // Max degrees to sweep = full circle
    private final int mAnimationDuration = 1000;       // Animation duration for progress change
    private final int mMaxProgress = 100;             // Max progress to use
